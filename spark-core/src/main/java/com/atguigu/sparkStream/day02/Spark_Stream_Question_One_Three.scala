...
/**
 * @ClassName: Spark_Stream_Question_One_Three
 * @Description: TODO
 * @Author: VmPerson
 * @Date: 2020/8/16  22:22
 * @Version: 1.0
 */
object Spark_Stream_Question_One_Three {
  def main(args: Array[String]): Unit = {
    val sparkConf: SparkConf = new SparkConf().setMaster("local[*]").setAppName("Spark_Stream_Question_One_Three")
